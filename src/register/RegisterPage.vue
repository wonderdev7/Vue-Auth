    ...
    <div>
        ...
        <form @submit.prevent="handleSubmit">
            ...
            <div class="form-group">
                ...
                <select v-model="user.gender" v-validate="'required'" name="gender" class="form-control" :class="{ 'is-invalid': submitted && errors.has('gender') }">
...
export default {
    ...
    methods: {
        ...
        setSelectedOption(selectOption) {
            this.config.placeholder = selectOption.value;
        }
    }
};
</script>